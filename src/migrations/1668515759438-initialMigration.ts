...
export class initialMigration1668515759438 implements MigrationInterface {
    name = 'initialMigration1668515759438'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "account" ("account_id" uuid NOT NULL, "balance" double precision, CONSTRAINT "PK_ea08b54a9d7322975ffc57fc612" PRIMARY KEY ("account_id"))`);
